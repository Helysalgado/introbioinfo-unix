...
**Antes de clase** lees este módulo (es corto: **no hay conceptos
...
::: {.callout-note title="una sola investigación"}
Las siete prácticas de esta sesión no son ejercicios sueltos:
...
::: {.callout-tip}
Si para tu secuencia desconocida conviene **otra** base o **otro** alfabeto que el de las
...
::: {.callout-important}
Una hipótesis honesta que declara no poder decidir entre dos explicaciones puede
...
::: {.callout-tip}
Si la IA «acertó» el identificador, eso **no** mejora su nota: la pregunta es si el
