...
::: {.callout-important}
No intercambies ensamblados con otros equipos. Cada proyecto representa un caso de
...
::: {.callout-important}
Toda afirmación debe estar respaldada por evidencia reproducible: el comando que
...
::: {.callout-note}
No se elabora un documento independiente. El protocolo construido desde la Unidad 1
