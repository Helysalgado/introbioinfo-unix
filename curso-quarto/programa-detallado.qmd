...
subtitle: "Introducción a la Bioinformática · LCG · UNAM · 2026"
description: "Programa completo del curso: descripción, propósito, enfoque formativo, ejes de contenido, contenido por unidad, competencias, metodología, evaluación y perfil de egreso."
toc: true
toc-depth: 3
toc-expand: 2
---
...
Esta es la versión completa del programa. Para la **ruta de sesiones** y el acceso
directo a cada módulo, ve a [Programa](programa.qmd). Para empezar a estudiar,
[Unidad 1](u1-trabajo-reproducible.md).
:::

**Plan operativo:** 34 sesiones de 2 horas · **Organización:** 6 unidades más los ejes
transversales de reproducibilidad, buenas prácticas y uso crítico de inteligencia artificial.
...
[Abrir la unidad →](u1-trabajo-reproducible.md)
...
[Abrir la unidad →](u2-entorno-unix.md)
...
[Abrir la unidad →](u3-datos-bases-datos.md)
...
[Abrir la unidad →](u4-procesamiento-exploracion.md)
...
[Abrir la unidad →](u5-automatizacion-scripting.md)
...
[Abrir la unidad →](u6-comparacion-homologia.md)
