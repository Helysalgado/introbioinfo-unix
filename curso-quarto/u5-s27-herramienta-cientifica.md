...
::: {.callout-important title="hoy no aprendes a escribir un README"}
Aprendes a **poner por escrito lo que hasta
...
::: {.callout-tip title="el experimento vale más si duele"}
La tentación es explicar «solo una cosita» cuando la
...
Igual que en las sesiones anteriores: **Concepto
esencial**, **Concepto de apoyo** y **Consulta**.
:::

::: {.callout-important title="qué cabe en dos horas"}
En el taller se escribe la documentación y se prueba a
...
::: {.callout-important}
Haz esta práctica **antes** de leer las secciones 2 a 7. Si las lees primero, ya
...
::: {.callout-tip title="por qué el software se documenta como se documentan los datos"}
Los principios FAIR
...
::: {.callout-warning title="el error más común de esta sesión"}
Copiar secciones del protocolo dentro del
...
::: {.callout-tip title="la excepción"}
Si tus datos **no** están publicados —porque los generó tu grupo, o
...
::: {.callout-tip}
La división no es decorativa. Alguien que evalúa si tu herramienta le sirve lee solo el
...
::: {.callout-tip}
Escribe la ayuda como si fuera un cartel, no un manual: lo que cabe en una pantalla sin
...
::: {.callout-note title="dónde estás en el ciclo"}
Esta práctica recorre una vuelta completa. Las partes A y B las
...
::: {.callout-important title="el apartado 7 es el que no puede escribir nadie más que tú"}
El `README` dice cómo
...
::: {.callout-warning}
La última frase del prompt es la importante. Todo lo que el asistente **no** puede
...
::: {.callout-tip}
Antes de S28, lee tu protocolo entero, de la Unidad 1 hasta hoy. Es la única vez del curso
