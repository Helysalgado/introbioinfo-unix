...
::: {.callout-note title="Cómo se estudia esta unidad"}
La Unidad 6 es esta portada más **cinco módulos** de dos
...
::: {.callout-important title="lo que esta unidad NO es"}
No es un curso de BLAST. Al terminar no habrás
...
::: {.callout-note title="nivel real"}
*Explicar*, *ejecutar* y *distinguir* se alcanzan plenamente. *Construir una
...
::: {.callout-note title="sobre el número de sesiones"}
La arquitectura pedagógica propuso seis etapas y el Plan
...
Dos de esos archivos —`NP_000508` y `NP_000549`— contienen **exactamente la misma
...
::: {.callout-warning title="el riesgo específico de esta unidad"}
En U5 el peligro era aceptar código que no
...
::: {.callout-important title="nunca solo comandos ni capturas de pantalla"}
Una captura de la salida de BLAST no
...
::: {.callout-important title="cómo se califica"}
La calidad del informe depende de **la argumentación, no del
