...
**Antes de clase** lees este módulo, empiezas Fitch (1970) o Koonin
...
Distinguir conceptos y declarar límites se alcanzan plenamente. Integrar
...
::: {.callout-important}
Afirmar homología no es «subir el tono» de un porcentaje. Es **cambiar de tipo de
...
::: {.callout-warning}
Con un solo BLAST no «demuestras» ortología. En la práctica se usan criterios
...
::: {.callout-important}
Hoy levantamos la prohibición del vocabulario evolutivo **con condiciones**. En S34
