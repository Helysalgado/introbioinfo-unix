...
| **Datos** | Secuencia anonimizada del acervo de la unidad; reutilizas alineamientos, bases y `.tsv` de S30–S33 |
...
- [ ] Tengo acceso a `results/s30/`, `results/s31/`, `results/s32/`, `results/s33/` (o sé
      reconstruirlos).
- [ ] Recibí el archivo de la secuencia desconocida en `data/source/desconocidas/` y **no** edité el
      original.
...
1. Abre la secuencia desconocida. Anota longitud, alfabeto aparente y cualquier pista del nombre del
   archivo **sin** tratar el nombre como conclusión.
...
| Archivo | Contenido |
| --- | --- |
| `data/source/desconocidas/…` | Secuencia asignada (intacta) |
...
## Anexo A — Resultado, actividad, evidencia, criterio, momento, nivel
...
| Secuencia desconocida | *Blind / anonymized sequence* | Consulta sin identidad revelada de antemano |
...
>
> **Secuencias desconocidas.** Preparar antes (auditoría §7): FASTA anonimizados de dificultad
> variada. Sin ellas, el informe puede hacerse sobre `ubiE` «como si» fuera desconocida —peor, pero
> evaluable por argumentación.
>
