...
> **NOTA — Aula invertida.** Este documento se lee **antes de la sesión S6**. No introduce
...
> **IMPORTANTE — qué NO es esta sesión.** No es un repaso ni un examen sorpresa. Es la diferencia
...
> **NOTA:** En S5 practicaste con copias precisamente para no tocar los originales. Hoy lo
...
> **NOTA:** La verificación tiene un coste, y por eso conviene hacerla bien: se verifica **lo que
...
> **TIP:** Si en la columna «¿con qué lo comprobarías?» te quedas en blanco en alguna fila, márcala.
...
> **ADVERTENCIA:** Si `hostname` no devuelve el nombre del servidor del curso, **estás en tu propia
...
> **NOTA — archivos que aparecen solos.** Verás cosas que no pusiste ahí a propósito: restos de las
...
> **ADVERTENCIA:** No elimines nada de `data/source/`. Si algo te sobra ahí, anótalo y consúltalo: es
...
> **TIP — prompt al asistente del curso.** *«Explícame qué significa cada columna de la salida de
...
> **IMPORTANTE:** El archivo de sumas se guarda en `doc/`, **no** en `data/source/`. Es documentación
...
> **ADVERTENCIA:** Un archivo `.md` con permiso de ejecución no es peligroso por sí mismo, pero es una
...
> **ADVERTENCIA — credenciales.** Si encuentras una contraseña en tu protocolo, elimínala ahora y
...
> **NOTA:** Esta es la primera revisión por pares del curso, y es deliberadamente corta. En S16 harás
...
> **NOTA — dónde irán los datos grandes.** Los archivos de esta unidad son pequeños y viven en tu
...
> **IMPORTANTE:** El apartado *Diferencias encontradas* no debe quedar vacío. Si de verdad no hubo
