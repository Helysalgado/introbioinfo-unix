...
> **NOTA — Aula invertida:** Esta unidad se estudia en diez sesiones. Antes de cada una leerás las
...
> **IMPORTANTE:** Estas preguntas **no cambian** a lo largo de la unidad. Lo que cambia eres tú. La
...
> **NOTA sobre el Plan operativo:** el Plan de clases 2026 asigna a la Tarea 6 el reporte de lectura
> del **Cap. 3** de Buffalo. Ese capítulo ya fue lectura base de la Unidad 2 (S3–S5), de modo que
> volver a reportarlo duplicaría la evidencia. La lectura obligatoria de esta unidad es el **Cap. 7,
> *Unix Data Tools***, que corresponde exactamente a su contenido. La numeración y el momento de la
> Tarea 6 no cambian.
...
> **ADVERTENCIA:** En esta unidad vas a leer, filtrar, contar y transformar tus archivos muchas veces.
...
> **NOTA:** Al terminar S13 cierras el **Estado 1 del genoma**: sabes su tamaño, cuántos replicones
...
> **IMPORTANTE:** Los tres últimos apartados son la marca distintiva de esta unidad. Un protocolo que
...
> **ADVERTENCIA:** Esta unidad es especialmente propicia para las alucinaciones técnicas: opciones de
