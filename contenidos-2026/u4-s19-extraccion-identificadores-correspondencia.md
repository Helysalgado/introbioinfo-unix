...
> **IMPORTANTE — el cambio de esta sesión.** Hasta ahora seguías **archivos**: abrías uno, lo
...
> **NOTA:** Fíjate en la penúltima fila. Hoy vas a extraer listas de identificadores, pero **todavía
...
> **TIP:** Crea hoy `results/s19/`. Vas a generar varias listas y el valor de la sesión está
...
> **NOTA — dos precisiones sobre la figura.** El patrón del paso 2 está escrito con abreviaturas
...
> **IMPORTANTE — no todas las claves están siempre.** La especificación GFF3 no obliga a que un
...
> **ADVERTENCIA — el patrón ambicioso.** Si escribes `locus_tag=.*`, el comodín no se detiene en el
...
> **ADVERTENCIA:** `comm` exige que las dos listas estén **ordenadas**. Si no lo están, no da error:
...
> **IMPORTANTE:** Aquí reaparece, con una cara nueva, la advertencia de S13: *un registro no es un
...
> **ADVERTENCIA:** Para tareas de extracción, los asistentes proponen a menudo herramientas que
...
> **TIP:** Guarda `results/s19/` completo. Esas listas son la materia prima de S20: ahí aprenderás a
