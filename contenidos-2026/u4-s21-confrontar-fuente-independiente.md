...
> **NOTA — Aula invertida:** Antes de clase descargarás una tabla de una fuente independiente,
...
> **IMPORTANTE:** Hoy no hay ninguna herramienta nueva. Todo lo que necesitas ya lo sabes hacer. Lo
...
> **NOTA — puede que coincidan mucho.** Si tu organismo está bien estudiado, la mayoría de los
...
> **TIP:** Descarga la tabla con tiempo. Si el recurso no responde o cambia, usa la copia de
...
> **IMPORTANTE — la consulta y el archivo no son lo mismo.** Una URL de consulta permite **repetir la
...
> **TIP — copia de respaldo.** El docente descarga previamente la misma exportación y la deja en la
...
> **IMPORTANTE — el encabezado no es un dato.** Si lo arrastras, se convertirá en un identificador
...
> **IMPORTANTE:** Una diferencia por alcance no es un desacuerdo sobre la existencia del gen. Que un
...
> **NOTA — el cuarto eslabón depende de tu auditoría.** `tr ' ' '\n'` convierte cada espacio en un
...
> **ADVERTENCIA — el riesgo es mayor que en S20.** Allí normalizabas dos listas del mismo productor y
...
> **NOTA — hoy solo cuentas.** Tres números, sin porcentajes. Calcular qué proporción representa cada
...
> **IMPORTANTE:** La zona central no es "lo aburrido". Es lo único de tu inventario que hoy queda
...
> **IMPORTANTE — no siempre hay respuesta.** Para varias discrepancias, la evidencia disponible no
...
> **IMPORTANTE:** La tabla de hipótesis es el corazón de esta sección. Un protocolo que solo registre
...
> **ADVERTENCIA:** Ante una discrepancia, un asistente tiende a proponer la explicación más común en
...
> **TIP:** Conserva `results/s21/` completo, sobre todo los archivos de cada zona. En S22 volverás
