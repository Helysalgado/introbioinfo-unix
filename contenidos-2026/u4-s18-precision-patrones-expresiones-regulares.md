...
> **NOTA — sobre la última columna de la figura.** Existen distintas variantes del lenguaje de
...
> **ADVERTENCIA:** El visualizador sirve para **comprender y depurar** un patrón; la evidencia se
...
> **ADVERTENCIA:** Los asistentes suelen proponer patrones de otras variantes del lenguaje, como `\d`
...
> **TIP:** Guarda `results/s18/` completo y conserva `results/s13/` sin tocar. En S19 partirás de las
