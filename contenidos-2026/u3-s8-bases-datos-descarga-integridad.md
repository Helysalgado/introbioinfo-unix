...
> **COMENTARIO:** Genome no es una base de datos de secuencias independiente ni compite con Assembly:
...
> **COMENTARIO:** `ASM584v2` y `GCF_000005845.2` no son lo mismo. `ASM584v2` es el **nombre** que el
...
> ficha de procedencia como registro del proyecto. Si más adelante el Plan se detalla de otra forma,
